...
import (
	...
	"github.com/sanprasirt/pcbook/service"
...
func TestClientSearchLaptop(t *testing.T) {
	...
	for i := 0; i < 6; i++ {
		...
		case 3:
			laptop.Memery = &pb.Memory{Value: 4096, Unit: pb.Memory_MEGABYTE}
		case 4:
			laptop.PriceUsd = 1999
			laptop.Cpu.NumberCores = 4
			laptop.Cpu.MinGhz = 2.5
			laptop.Cpu.MaxGhz = laptop.Cpu.MinGhz + 2.0
			laptop.Memery = &pb.Memory{Value: 16, Unit: pb.Memory_GIGABYTE}
		...
		case 5:
			...
			laptop.Cpu.MaxGhz = laptop.Cpu.MinGhz + 2.0
			laptop.Memery = &pb.Memory{Value: 64, Unit: pb.Memory_GIGABYTE}
			expectedIDs[laptop.Id] = true
		}
